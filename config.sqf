...
ammoArray = [
	...
	["7.62mm 20Rnd Mag V.56","20Rnd_762x45_Mag",20],
	["7.62mm 20Rnd Mag V.57","20Rnd_762x51_Mag",20],
...
accessoriesArray = [
	...
	["Diver Goggles","G_Diving",50,"item"],
    ...
    ["Rebreather 1","V_RebreatherB", 50,"vest"],
    ["Rebreather 2","V_RebreatherIR", 50,"vest"],
