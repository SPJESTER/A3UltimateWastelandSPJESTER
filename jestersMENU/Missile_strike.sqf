...
_price = 10000;//Price to call in missile strike
...
if(_price < (player getVariable "cmoney")) exitWith //if the player has enough money then start the script
{
	...
	onMapSingleClick "_pos call missle1;";//wait until player clicks then get the position of the click and call the script
